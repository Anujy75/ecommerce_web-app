...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Fetch recent orders (mock - backend se connect karna hoga)
  ...
  const getStatusBadge = (status) => {
    switch(status) {
      ...
      case "Shipped":
        return { color: "#3b82f6", bg: "#dbeafe", text: "🚚 Shipped" };
      default:
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.statsGrid}>
          ...
          >
            <div style={{ ...styles.statIcon, background: "#8b5cf615", color: "#8b5cf6", cursor: "pointer" }}>
              ⚙️
            </div>
        ...
        <div style={styles.twoColumn}>
                  ...
                  return (
                    ...
                    >
                      <div style={styles.orderHeader}>
                        ...
                        <span style={{ ...styles.orderStatus, background: status.bg, color: status.color }}>
                          {status.text}
                        </span>
                      </div>
          ...
          >
            <div style={styles.sectionHeader}>
              ...
              {wishlist.length > 0 && (
                <button style={styles.viewAllBtn} onClick={() => navigate("/wishlist")}>
                  View All →
                </button>
              )}
            </div>
        ...
        >
          ...
          <div style={styles.actionsGrid}>
            <motion.button whileHover={{ scale: 1.02 }} style={styles.actionBtn} onClick={() => navigate("/products")}>
              🛒 Continue Shopping
            </motion.button>
            <motion.button whileHover={{ scale: 1.02 }} style={styles.actionBtn} onClick={() => navigate("/profile")}>
              ✏️ Edit Profile
            </motion.button>
            <motion.button whileHover={{ scale: 1.02 }} style={styles.actionBtn} onClick={() => navigate("/cart")}>
              🛍️ View Cart
            </motion.button>
            <motion.button whileHover={{ scale: 1.02 }} style={styles.actionBtn} onClick={() => navigate("/orders")}>
              📦 Track Orders
            </motion.button>
          </div>
        </motion.div>
